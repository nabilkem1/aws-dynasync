import { Attribute, BillingMode, StreamViewType, TableClass, TableEncryption } from "aws-cdk-lib/aws-dynamodb";
...
export type GraphType = 'id' | 'string' | 'int' | 'float' | 'boolean' | 'awsDate' | 'awsTime' | 'awsDateTime' | 'awsTimestamp' | 'awsEmail' | 'awsJson' | 'awsUrl' | 'awsPhone' | 'awsIpAddress' | 'intermediate';
